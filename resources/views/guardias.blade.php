...
<html class="no-js">
	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<br><br>
            <div id="tittle">
                DISPOSICIÓN SEMANAL <br> DE GUARDIAS
            </div>
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content">
				<h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">CALENDARIOS</h2>
					<div class="row">

                        @foreach ( $calendarios as $calendario )
                        <br>
                        <h2 class="calendarios">{{ ucfirst($calendario->tipo) }}</h2>
                        <iframe src="{{ asset('storage/archivos/'.$calendario->archivo) }}#page=3"
                            width="80%" height="600px" style="border: none;">
                    </iframe>
